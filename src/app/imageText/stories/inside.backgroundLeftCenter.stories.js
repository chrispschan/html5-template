...
import htmlCode from './inside.backgroundLeftCenter.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundLeftCenter.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Left Center', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
