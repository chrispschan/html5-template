...
import scssCode from '!!raw-loader!./overlay.stories.scss';
...
import styleCode from '!!raw-loader!sass-loader!./overlay.stories.scss';
...
storiesOf('scrollbar', module)
  ...
  .add('Overlay', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
