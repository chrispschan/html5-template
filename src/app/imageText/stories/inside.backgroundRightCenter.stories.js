...
import htmlCode from './inside.backgroundRightCenter.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundRightCenter.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Right Center', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
