...
const watchFiles = {
        js: gulpOptions.watchAppFolder ? ['./src/js/**/*.js', './src/app/**/*.js', '!./src/js/**/_*.js', '!./src/js/**/*.spec.js', '!./src/js/**/*.min.*', '!./src/js/**/*.es5.js', '!./src/app/**/_*.js', '!./src/app/**/*.spec.js'] : ['./src/js/**/*.js', '!./src/js/**/_*.js', '!./src/js/**/*.spec.js', '!./src/js/**/*.min.*', '!./src/js/**/*.es5.js'],
        ...
        jsLint: ['./src/app/**/*.js', './src/js/**/*.js', '!./src/app/**/_*.js', '!./src/app/**/*.spec.js', '!./src/js/**/_*.js', '!./src/js/**/*.spec.js', '!./src/js/**/*.min.*']
    },
    buildFiles = {
