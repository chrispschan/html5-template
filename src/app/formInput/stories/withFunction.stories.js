...
import htmlCode from './withFunction.stories.html';
import nunjucksCode from '!!raw-loader!./withFunction.stories.html';
...
import jsCode from '!!raw-loader!./withFunction.stories.function.js';

import styleCode from '!!raw-loader!sass-loader!./formInput.stories.scss';

import script from 'raw-loader!./withFunction.stories.function.js';
...
storiesOf('formInput', module)
  ...
  .add('With Function', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
