...
import htmlCode from './inside.backgroundLeftBottom.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundLeftBottom.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Left Bottom', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
