...
import htmlCode from './inline.bottom.stories.html';
import nunjucksCode from '!!raw-loader!./inline.bottom.stories.html';
...
storiesOf('imageText/Inline', module)
  ...
  .add('Bottom', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
