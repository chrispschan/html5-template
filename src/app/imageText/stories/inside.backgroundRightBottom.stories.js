...
import htmlCode from './inside.backgroundRightBottom.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundRightBottom.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Right Bottom', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
