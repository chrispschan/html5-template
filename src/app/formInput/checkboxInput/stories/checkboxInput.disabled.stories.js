...
import htmlCode from './checkboxInput.disabled.stories.html';
import nunjucksCode from '!!raw-loader!./checkboxInput.disabled.stories.html';
import scssCode from '!!raw-loader!../../stories/formInput.stories.scss';
import defaultVariablesCode from '!!raw-loader!../checkboxInput.variables.scss';
...
storiesOf('formInput/checkboxInput', module)
  .addParameters({
    readme: {
      sidebar: ``
    }
