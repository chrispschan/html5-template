...
import htmlCode from './inside.backgroundCenterTop.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundCenterTop.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Center Top', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
