...
import htmlCode from './inside.backgroundCenterBottom.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundCenterBottom.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Center Bottom', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
