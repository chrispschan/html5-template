...
import htmlCode from './horizontal.item.bottom.stories.html';
import nunjucksCode from '!!raw-loader!./horizontal.item.bottom.stories.html';
...
storiesOf('imageText/Horizontal', module)
  ...
  .add('Items Align Bottom', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
