...
import htmlCode from './inside.backgroundRightTop.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundRightTop.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Right Top', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
