...
import htmlCode from './inside.contain.stories.html';
import nunjucksCode from '!!raw-loader!./inside.contain.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Contain', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
