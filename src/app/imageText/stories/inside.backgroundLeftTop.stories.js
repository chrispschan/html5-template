...
import htmlCode from './inside.backgroundLeftTop.stories.html';
import nunjucksCode from '!!raw-loader!./inside.backgroundLeftTop.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Postion - Left Top', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
