...
import htmlCode from './inside.cover.stories.html';
import nunjucksCode from '!!raw-loader!./inside.cover.stories.html';
...
storiesOf('imageText/Inside', module)
  ...
  .add('Background Cover', () => `<style type="text/css">${styleCode}</style>${htmlCode}`);
